//-----------------------------------------------------------------------
// <copyright file="Joystick.cs" company="Scalify">
...
/// <summary>
/// Joystick class is translated from the Joystick.js script (Standard Assets (mobile)).
/// </summary>
public class Joystick : MonoBehaviour 
{
	...
	void ResetJoystick()
	{
		...
		if ( touchPad )
		{
			gui.color = new Color(0, 0, 0, 0.025f);	
		}
	}
